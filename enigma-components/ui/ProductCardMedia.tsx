    ...
    return (
        <div className="relative mb-4 aspect-[3/4] overflow-hidden rounded-card bg-bg-surface @md:mb-6">
            ...
            {badge ? (
                <span
                    className={cn(
                        "absolute left-3 top-3 rounded-badge px-2 py-1 text-[9px] font-black uppercase tracking-widest @md:left-4 @md:top-4 @md:px-3 @md:py-1 @md:text-[10px]",
            ...
            {showWishlist ? (
                <button
                    ...
                    className={cn(
                        "absolute right-3 top-3 rounded-full bg-bg-surface/80 p-1.5 opacity-0 backdrop-blur-sm transition-opacity duration-300 hover:bg-bg-surface disabled:cursor-not-allowed disabled:opacity-60 @md:right-4 @md:top-4 @md:p-2",
            ...
            {!product.inStock ? (
                <div className="absolute inset-0 flex items-center justify-center bg-bg-overlay/60">
            ...
            {showQuickAdd && product.inStock ? (
                <button
                    ...
                    disabled={isAdding}
                    className={cn(
                        "absolute bottom-3 left-3 right-3 translate-y-12 rounded-button bg-bg-surface/95 py-2.5 text-xs font-bold text-text-base opacity-0 shadow-card backdrop-blur-sm transition-all duration-300 hover:bg-primary hover:text-on-primary disabled:cursor-not-allowed disabled:opacity-70 @md:bottom-4 @md:left-4 @md:right-4 @md:py-3 @md:text-sm",
