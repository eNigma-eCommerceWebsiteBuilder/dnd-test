            ...
            <div className="w-full px-4 py-3 flex flex-col @md:flex-row @md:items-center @md:justify-between gap-2 @md:gap-4">
                ...
                {hasCta && (
                    <Link
                        ...
                        className="inline-flex items-center justify-center rounded-button bg-cta-primary px-4 py-2 text-xs font-semibold text-on-primary transition-colors duration-300 hover:bg-cta-primary-hover"
                    >
                        {promotion.ctaText}
                    </Link>
                )}
