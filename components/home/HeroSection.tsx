                ...
                <div className="relative flex h-full max-w-3xl flex-col justify-end gap-6 p-6 @md:p-8 @lg:p-12">
                    ...
                    <div className="flex flex-col gap-3 @md:flex-row">
                        <Link
                            ...
                            className="inline-flex items-center justify-center rounded-button bg-cta-primary px-6 py-3 text-sm font-semibold text-on-primary shadow-button transition-all duration-300 hover:-translate-y-0.5 hover:bg-cta-primary-hover hover:shadow-button-hover @md:px-8 @md:py-4"
                        >
                            {content.ctaPrimary}
                        </Link>
                        <Link
                            href="/collections/all"
                            className="inline-flex items-center justify-center rounded-button border border-border-light/60 bg-bg-surface/10 px-6 py-3 text-sm font-semibold text-text-inverse backdrop-blur-sm transition-colors duration-300 hover:bg-bg-surface/20 @md:px-8 @md:py-4"
                        >
