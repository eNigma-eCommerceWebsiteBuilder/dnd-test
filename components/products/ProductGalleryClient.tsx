...
export function ProductGalleryClient({ images, productName, className }: ProductGalleryClientProps) {
  ...
  return (
    <div className={cn('@container flex flex-col gap-4 @md:flex-row', className)}>
      ...
      <div className="order-1 relative aspect-[3/4] flex-1 overflow-hidden rounded-image bg-bg-surface @md:order-2">
        <Image
          src={mainImage}
          alt={productName}
          fill
