...
export const puckAst = { kind: 'runtime', slots: ['content'], sourceJsxNames: ['ReviewsSection', 'TestimonialsSection'], role: 'product-detail-section', requiredClasses: ['mt-24', 'border-t', 'pt-16'] };
export function ProductDetailSectionView(props: Props) { return <ProductDetailSection {...props} />; }
