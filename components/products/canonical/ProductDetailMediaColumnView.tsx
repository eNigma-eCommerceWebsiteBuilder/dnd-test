...
export const puckAst = { kind: 'runtime', slots: ['gallery', 'desktopTabs'], sourceJsxNames: ['ProductDetailMediaColumn'], sourceImportPaths: ['@/components/products/canonical/ProductDetailMediaColumn'], role: 'product-detail-media-column', slotTarget: 'media', requiredClasses: ['lg:col-span-7', 'mt-16', 'hidden', 'lg:block'] };
export function ProductDetailMediaColumnView(props: Props) { return <ProductDetailMediaColumn gallery={props.gallery?.(puckTransparentSlotProps)} desktopTabs={props.desktopTabs?.(puckTransparentSlotProps)} />; }
