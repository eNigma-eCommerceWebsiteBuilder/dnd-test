...
interface Props { hasSiblings?: boolean; previewMode?: 'visible' | 'hidden'; content?: CatalogSlot; }
...
export const puckAst = { kind: 'runtime', slots: ['content'], sourceJsxNames: ['SubcategoryNav'], sourceImportPaths: ['@/components/categories/SubcategoryNav'], role: 'category-subcategory-condition', slotTarget: 'subcategories', conditional: 'siblingCategories.length > 0', runtimeSignals: ['category.siblings'] };
...
export function CategorySubcategoryConditionView(props: Props) { return <CategorySubcategoryCondition hasSiblings={props.hasSiblings} previewMode={props.previewMode} content={props.content?.()} />; }
